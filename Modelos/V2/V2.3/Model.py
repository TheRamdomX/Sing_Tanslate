...
# División de datos
X_train, X_test, y_train, y_test = train_test_split(X, y_categorical, test_size=0.8, random_state=42)
...
def augment_data(X, y, noise_factor=0.1):
    ...
    variation = np.random.uniform(-0.2, 0.2, X.shape)
    X_aug += variation
